...
export const sessionsPopup = document.getElementById("sessions-popup")!;
export const sessionsTitle = document.getElementById("sessions-title")!;
export const sessionsList = document.getElementById("sessions-list")!;
